...
const Home = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description:
        "Explore the art of relaxation and heightened awareness with our sensual massage. This intimate experience is designed to awaken the senses, promoting a deep connection between mind and body. Through gentle, flowing strokes, Dulce's Massage Therapy skilled therapist creates an atmosphere of tranquility and comfort",
      image:
    ...
    },
    {
      ...
      description:
        "Enhance your massage experience with the therapeutic benefits of essential oils. Dulce's Massage Therapy therapy uses oils specifically chosen for your needs, whether for relaxation, energy, or immune support. The combination of massage and aromatherapy creates a multi-sensory experience that nurtures both body and mind.",
      image:
